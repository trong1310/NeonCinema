...
namespace NeonCinema_Infrastructure.Implement.BillDetails
{
    public class BillDetailsRepository : IBillDetailsRepository
    {
        ...
        public async Task<HttpResponseMessage> Create(BillDetail input, CancellationToken cancellationToken)
        {
            try
            {
                if(input.Price == null ||
        ...
        public Task<HttpResponseMessage> Delete(BillDetail bill, CancellationToken cancellationToken)
        {
        ...
        public Task<HttpResponseMessage> Update(BillDetail bill, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
    }

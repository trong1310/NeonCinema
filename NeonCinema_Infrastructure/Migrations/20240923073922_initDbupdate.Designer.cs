...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20240923073922_initDbupdate")]
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Movies", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ID = new Guid("e6e03e8e-2384-463a-8346-880a9789b6c7"),
                            AgeAllowed = 18,
                            CountryID = new Guid("4b2a3f4c-6e7d-4f7e-8c2d-d4d5f6a0b1c3"),
                        ...
                        new
                        {
                            ID = new Guid("4008d984-b1f5-47eb-b1a8-fa4d23cb7b30"),
                            AgeAllowed = 18,
                            CountryID = new Guid("4b2a3f4c-6e7d-4f7e-8c2d-d4d5f6a0b1c3"),
                            Description = "Câu chuyện này tập trung vào cuộc sống sau về hưu của một cảnh sát ở một xóm nhỏ của Sài Gòn. Dù đã rời khỏi ngành công an, tinh thần đoàn kết và lòng yêu nghề của chú cảnh sát vẫn rạng ngời. Trong một thời gian dài sống tại khu vực này, chú quyết định hợp tác với những thanh niên có hoàn cảnh và tính cách cá biệt để thực hiện một phi vụ điều tra bí ẩn.\r\n\r\nCuộc hợp tác bất ngờ này không chỉ kéo chú cảnh sát trở lại cuộc sống căng thẳng và hối hả của việc làm cảnh sát, mà còn khiến cho cuộc sống của họ trở nên rối ren và hài hước. Họ quyết định mua lại một quán cơm tấm tại xóm nhỏ để che mắt tội phạm và làm nơi tập trung thực hiện các hoạt động điều tra.\r\n\r\nKhông lâu sau, quán cơm tấm của họ trở nên nổi tiếng trong khu vực với những dĩa cơm thơm ngon và phục vụ tận tâm. Điều này không chỉ thu hút sự quan tâm của người dân trong khu vực mà còn của những khách hàng xa xôi. Sự thành công của quán cơm tấm bắt đầu tạo ra những trở ngại cho phi vụ điều tra của họ, và họ phải đối mặt với nhiều tình huống dở khóc dở cười trong quá trình điều tra.",
                            DirectorID = new Guid("5a1d9b1a-71f2-4e29-b3a5-8f4c0a5e94de"),
                        ...
                        new
                        {
                            ID = new Guid("92687070-c3a5-4599-a153-189730caaabc"),
                            AgeAllowed = 18,
                            CountryID = new Guid("4b2a3f4c-6e7d-4f7e-8c2d-d4d5f6a0b1c3"),
                        ...
                        new
                        {
                            ID = new Guid("dc418704-38c2-4128-aaf4-9772051969db"),
                            AgeAllowed = 18,
                            CountryID = new Guid("4b2a3f4c-6e7d-4f7e-8c2d-d4d5f6a0b1c3"),
                            Description = "Bộ phim tương tác với đề tài giới tính thứ 3 qua cuộc sống của Mến và Nhớ. Tại miền Tây sông nước, sự kỳ thị và áp lực xã hội đặt lên họ trở thành hình mẫu tiêu biểu cho câu chuyện về sự đấu tranh vì tình yêu và sự chấp nhận. Cặp đôi Mến - Nhớ đã phải vượt qua những khó khăn và thách thức đặt ra bởi xã hội và cuộc sống hàng ngày để tìm kiếm hạnh phúc của mình.\r\n\r\nTuy nhiên, bi kịch không ngờ đến khi Nhớ bắt đầu từ bỏ, dẫn đến việc anh bắt đầu du nhập vào những mối quan hệ mới với những cô gái khác... Cuộc hành trình của họ đánh dấu một câu chuyện đầy bi thương về tình yêu và sự thay đổi trong một xã hội định kiến.",
                            DirectorID = new Guid("5a1d9b1a-71f2-4e29-b3a5-8f4c0a5e94de"),
                        ...
                        new
                        {
                            ID = new Guid("e707beb6-dd16-46c9-898a-8f27094fee10"),
                            AgeAllowed = 18,
                            CountryID = new Guid("4b2a3f4c-6e7d-4f7e-8c2d-d4d5f6a0b1c3"),
                            Description = "Bộ phim tương tác với đề tài giới tính thứ 3 qua cuộc sống của Mến và Nhớ. Tại miền Tây sông nước, sự kỳ thị và áp lực xã hội đặt lên họ trở thành hình mẫu tiêu biểu cho câu chuyện về sự đấu tranh vì tình yêu và sự chấp nhận. Cặp đôi Mến - Nhớ đã phải vượt qua những khó khăn và thách thức đặt ra bởi xã hội và cuộc sống hàng ngày để tìm kiếm hạnh phúc của mình.\r\n\r\nTuy nhiên, bi kịch không ngờ đến khi Nhớ bắt đầu từ bỏ, dẫn đến việc anh bắt đầu du nhập vào những mối quan hệ mới với những cô gái khác... Cuộc hành trình của họ đánh dấu một câu chuyện đầy bi thương về tình yêu và sự thay đổi trong một xã hội định kiến.",
                            DirectorID = new Guid("5a1d9b1a-71f2-4e29-b3a5-8f4c0a5e94de"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(6063),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(6129),
                            RoleName = "Client",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(6131),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("3c46d883-31ca-4bac-90eb-b8cf3c0dd1db"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(6256),
                        ...
                        new
                        {
                            ID = new Guid("5ad4aa91-6d14-460a-936a-0fd110eb9724"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(6977),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("15218d81-a5df-49ae-bd85-bf59047f47b0"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(7015),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("c9da6f91-f6f7-41ee-b77a-3d4b76cfd1b2"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(7052),
                        ...
                        new
                        {
                            ID = new Guid("0fc74633-8805-425e-91c0-53e944138790"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(7082),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("76b46709-216e-4a74-94f4-63e1d4b06b9d"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 14, 39, 22, 433, DateTimeKind.Local).AddTicks(7121),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),

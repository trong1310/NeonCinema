    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                column: "CreatedTime",
                value: new DateTimeOffset(new DateTime(2024, 9, 18, 15, 6, 23, 744, DateTimeKind.Unspecified).AddTicks(5055), new TimeSpan(0, 7, 0, 0, 0)));
            ...
            migrationBuilder.UpdateData(
                ...
                column: "CreatedTime",
                value: new DateTimeOffset(new DateTime(2024, 9, 18, 15, 6, 23, 744, DateTimeKind.Unspecified).AddTicks(5095), new TimeSpan(0, 7, 0, 0, 0)));
            ...
            migrationBuilder.UpdateData(
                ...
                column: "CreatedTime",
                value: new DateTimeOffset(new DateTime(2024, 9, 18, 15, 6, 23, 744, DateTimeKind.Unspecified).AddTicks(5093), new TimeSpan(0, 7, 0, 0, 0)));
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Users",
                keyColumn: "ID",
                keyValue: new Guid("151d41fc-2a08-44f3-9dc0-55e003261677"));

            migrationBuilder.DeleteData(
                table: "Users",
                keyColumn: "ID",
                keyValue: new Guid("2dd04f59-d192-45b0-a068-48853c81a7f2"));

            migrationBuilder.DeleteData(
                table: "Users",
                keyColumn: "ID",
                keyValue: new Guid("4a76a80d-7177-4ddb-a125-9b2c27aae0e0"));

            migrationBuilder.DeleteData(
                table: "Users",
                keyColumn: "ID",
                keyValue: new Guid("6fe8b3a7-d48a-4a3c-8e8f-058eedad5f71"));

            migrationBuilder.DeleteData(
                table: "Users",
                keyColumn: "ID",
                keyValue: new Guid("71e3f643-97f0-4abc-b8db-3d1ffdce33a5"));

            migrationBuilder.DeleteData(
                table: "Users",
                keyColumn: "ID",
                keyValue: new Guid("bf52902f-1ae7-42d7-b9d4-5137f497c314"));

            migrationBuilder.DeleteData(
                table: "Users",
                keyColumn: "ID",
                keyValue: new Guid("e30623d0-3a78-42fb-b044-0df0ec86265e"));

...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20240923030250_InitDba")]
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(4467),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(4484),
                            RoleName = "Client",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(4486),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("cba9c85c-1051-4c04-8a4e-40bc149d99c9"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(4579),
                        ...
                        new
                        {
                            ID = new Guid("c626c1a7-2ea7-41a9-9ba5-c52af19fa545"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(4969),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("2c522db4-27ce-4151-9701-9e5eee752f8c"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(4999),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("7e319fe5-0d16-480c-bae6-2b621a6882be"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(5029),
                        ...
                        new
                        {
                            ID = new Guid("ba294c84-b2c2-4547-96b2-4992f76dcfeb"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(5061),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("625caf9d-fb8e-4988-96d3-cdef6ff379de"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 23, 10, 2, 50, 581, DateTimeKind.Local).AddTicks(5088),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),

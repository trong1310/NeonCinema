...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20240920064243_initDb")]
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3178),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3196),
                            RoleName = "Client",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3198),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("0feebe9e-5b1e-4f30-be6d-595523d68518"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3303),
                        ...
                        new
                        {
                            ID = new Guid("0f1a1ec0-5653-4210-95f3-a273f97348a6"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3796),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("72b0dbd4-a5cd-49e3-8825-95660b822dbd"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3833),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("3476d660-70ff-4f3c-a86e-0bd16a0071ba"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3859),
                        ...
                        new
                        {
                            ID = new Guid("5195bb2c-8366-4356-b4b2-9e5695616cee"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3889),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("4817aed9-b95d-4a59-be62-c77811988385"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 20, 13, 42, 42, 849, DateTimeKind.Local).AddTicks(3917),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),

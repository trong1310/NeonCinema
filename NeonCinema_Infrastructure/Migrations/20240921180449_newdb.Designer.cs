...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20240921180449_newdb")]
    partial class newdb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Movies", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Inception",
                            StarTime = new DateTime(2010, 7, 16, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = 0,
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(5950),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(5989),
                            RoleName = "Client",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(5994),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("30858c26-81fb-4221-9b2d-63f1a2c4dd9a"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(6237),
                        ...
                        new
                        {
                            ID = new Guid("bf7303c0-471e-48c1-851f-49aa90799939"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(6952),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("bd413d8e-6f32-4e08-ad27-3eca89fc3790"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(7063),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("5effa9e2-164a-4a34-95ea-9eb53b49e62b"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(7175),
                        ...
                        new
                        {
                            ID = new Guid("79498d98-40b4-469e-96b4-879e7a2f053c"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(7249),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("d264b721-5823-46c5-a1ae-29e94f1ee6c9"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 9, 22, 1, 4, 49, 417, DateTimeKind.Local).AddTicks(7323),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),

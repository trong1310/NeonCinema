...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20241023162708_initnewss")]
    partial class initnewss
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Cinemas", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("6077f7df-3c6f-4904-950a-053daa307856"),
                            ClosingHours = "10:00 PM",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8449),
                            Location = "Hà Nội",
                            Name = "Cinema A",
                        ...
                        new
                        {
                            ID = new Guid("78243cc1-835b-4f34-b12d-bfa83688edf9"),
                            ClosingHours = "11:00 PM",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8454),
                            Location = "Đà Nẵng",
                            Name = "Cinema B",
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Countrys", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("5a856a02-19b2-4160-ae90-e7248a56f61d"),
                            CountryName = "Nhật Bản"
                        },
                        new
                        {
                            ID = new Guid("f222972d-fc10-4298-96c3-e6b50cbe3c4c"),
                            CountryName = "Vương Quốc Anh"
                        },
                        new
                        {
                            ID = new Guid("20a7015e-0db4-45d6-9274-49722ff8b6ed"),
                            CountryName = "Trung Quốc"
                        },
                        new
                        {
                            ID = new Guid("25ac65c9-609d-42f4-9ee8-d046dcae072d"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Director", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("0fa39925-db4e-4d95-b583-7b9cab876a44"),
                            Address = "Hà Nội",
                            Biography = "Có",
                        ...
                        new
                        {
                            ID = new Guid("3fb0113c-d7b5-4618-8266-230f1d04d026"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("940336c5-c118-4339-b033-5a21d54439b7"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("746573d9-459c-44e3-a331-44e5bdb86d66"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("b272734b-bb4e-42c0-b57f-4c48aeba76f2"),
                            GenreName = "Kịch tính"
                        },
                        new
                        {
                            ID = new Guid("100ecf48-53b7-4ced-8176-38e49b9f3078"),
                            GenreName = "Tình cảm"
                        },
                        new
                        {
                            ID = new Guid("6937c0af-f951-4ab6-a19c-48ed83570b70"),
                            GenreName = "2D"
                        },
                        new
                        {
                            ID = new Guid("7c52f0f4-0b39-40ed-960b-0f6a7f12e786"),
                            GenreName = "Hoạt hình"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("71713956-0db6-42d1-b5e7-e25df649acdd"),
                            LanguageName = "en"
                        },
                        new
                        {
                            ID = new Guid("273e2d05-9c67-44f2-b3ec-64b0b1aa4953"),
                            LanguageName = "vi"
                        },
                        new
                        {
                            ID = new Guid("153bf43b-8bf5-431d-b77d-0c2936fbfd83"),
                            LanguageName = "ja"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Movies", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("c0472444-12fe-4cb9-991c-d7d1c871d856"),
                            AgeAllowed = 18,
                            CountryID = new Guid("5a856a02-19b2-4160-ae90-e7248a56f61d"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8865),
                            Description = "An exciting action movie.",
                            DirectorID = new Guid("0fa39925-db4e-4d95-b583-7b9cab876a44"),
                            Duration = 120,
                            GenreID = new Guid("b272734b-bb4e-42c0-b57f-4c48aeba76f2"),
                            Images = "movieA.jpg",
                            LenguageID = new Guid("71713956-0db6-42d1-b5e7-e25df649acdd"),
                            Name = "Movie A",
                        ...
                        new
                        {
                            ID = new Guid("b8f5a6cf-5d7e-4786-9af8-0a1e0accb3d8"),
                            AgeAllowed = 16,
                            CountryID = new Guid("f222972d-fc10-4298-96c3-e6b50cbe3c4c"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8884),
                            Description = "A thrilling mystery.",
                            DirectorID = new Guid("3fb0113c-d7b5-4618-8266-230f1d04d026"),
                            Duration = 150,
                            GenreID = new Guid("100ecf48-53b7-4ced-8176-38e49b9f3078"),
                            Images = "movieB.jpg",
                            LenguageID = new Guid("273e2d05-9c67-44f2-b3ec-64b0b1aa4953"),
                            Name = "Movie B",
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(7268),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(7295),
                            RoleName = "Customer",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(7298),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("5fb0c2f7-10e6-4cc0-b5fc-e0869e9a77e7"),
                            CinemasID = new Guid("6077f7df-3c6f-4904-950a-053daa307856"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8724),
                            Name = "Room 1",
                            SeatID = new Guid("1ada5402-9b91-409b-b6b8-483986bf8494"),
                            SeatingCapacity = 100,
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("07ef48ce-ea3f-44e4-964f-d0eb83aeb662"),
                            CinemasID = new Guid("78243cc1-835b-4f34-b12d-bfa83688edf9"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8730),
                            Name = "Room 2",
                            SeatID = new Guid("1ada5402-9b91-409b-b6b8-483986bf8494"),
                            SeatingCapacity = 150,
                            Status = 1
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Screening", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("1dc29f67-b9f7-4629-9c9d-6abcc1a8456b"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8954),
                            MovieID = new Guid("c0472444-12fe-4cb9-991c-d7d1c871d856"),
                            RoomID = new Guid("5fb0c2f7-10e6-4cc0-b5fc-e0869e9a77e7"),
                            ShowDate = new DateTime(2024, 10, 25, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8939),
                            ShowTimeID = new Guid("efd476a2-d643-4097-b0bb-58966116653b"),
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("9137088b-0e0b-4b31-8a93-d19ebad2f3aa"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8965),
                            MovieID = new Guid("b8f5a6cf-5d7e-4786-9af8-0a1e0accb3d8"),
                            RoomID = new Guid("07ef48ce-ea3f-44e4-964f-d0eb83aeb662"),
                            ShowDate = new DateTime(2024, 10, 28, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8963),
                            ShowTimeID = new Guid("2a8e7e39-b2a6-465d-b501-0bfb72cdbc27"),
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Seat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("1ada5402-9b91-409b-b6b8-483986bf8494"),
                            Column = "1",
                            Row = "1",
                            SeatNumber = "1",
                            SeatTypeID = new Guid("cda00f3f-8fee-45e0-a5ff-0d5e21dedf79"),
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("251b56ad-947c-4537-ae74-5c10cf8f90cb"),
                            Column = "2",
                            Row = "2",
                            SeatNumber = "2",
                            SeatTypeID = new Guid("e6e3d186-39bf-4c47-9792-72d811f30282"),
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("89b9db84-505d-43b4-84a4-fb514e897c28"),
                            Column = "2",
                            Row = "2",
                            SeatNumber = "2",
                            SeatTypeID = new Guid("262e1173-a7a3-481c-84c0-cddeac726752"),
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.SeatType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("cda00f3f-8fee-45e0-a5ff-0d5e21dedf79"),
                            Price = 500000m,
                            SeatTypeName = "Ghế Vip"
                        },
                        new
                        {
                            ID = new Guid("e6e3d186-39bf-4c47-9792-72d811f30282"),
                            Price = 250000m,
                            SeatTypeName = "Ghế Thường"
                        },
                        new
                        {
                            ID = new Guid("262e1173-a7a3-481c-84c0-cddeac726752"),
                            Price = 400000m,
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.ShowTime", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("efd476a2-d643-4097-b0bb-58966116653b"),
                        ...
                        new
                        {
                            ID = new Guid("2a8e7e39-b2a6-465d-b501-0bfb72cdbc27"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("8c6921e3-948d-476d-9661-0fc7d20cd0a6"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(7468),
                        ...
                        new
                        {
                            ID = new Guid("c76d3483-562c-4eb2-a323-d0545b9be911"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(7925),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("348eb032-b960-4d7c-989e-8ad748f3963b"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(7958),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("bf96ba4d-0731-43c5-9f52-df87b72eef1f"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(7998),
                        ...
                        new
                        {
                            ID = new Guid("9d8fc51e-ee35-40b9-963e-d7f231d06ff6"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8024),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("3d9ed4e5-10f5-4cb5-b3c9-ab8dd7fa6b7c"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8055),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("bd7d8299-af0b-400b-849e-4fad0e011110"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8082),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "vantrongvt1310@gmail.com",
                            FullName = "Nguyễn Văn Trọng",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("edc4aef0-bf81-42b9-9576-716a8419a35c"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8123),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "Phongdxph35748@fpt.edu.vn",
                            FullName = "Đặng Xuân Phong",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("a7656347-f9be-4549-9420-1e6a2ac57932"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 27, 7, 711, DateTimeKind.Local).AddTicks(8146),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "cuongddpc07789@fpt.edu.vn",
                            FullName = "Đặng Đức Cường",
                            Gender = true,

...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20241005012022_intinn")]
    partial class intinn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Countrys", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("ccdb068d-4e88-48f7-a180-8c997cb2175a"),
                            CountryName = "Nhật Bản"
                        },
                        new
                        {
                            ID = new Guid("b82c52ff-a22e-40f8-a38c-64bff93bc992"),
                            CountryName = "Vương Quốc Anh"
                        },
                        new
                        {
                            ID = new Guid("e7126555-da58-4668-b8c4-bd90d443f134"),
                            CountryName = "Trung Quốc"
                        },
                        new
                        {
                            ID = new Guid("d86b6f8d-772e-48b1-a3f9-2d164d13797b"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Director", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("651d3b1e-3fa2-4fd4-a212-1d0f77ae013e"),
                            Address = "Hà Nội",
                            Biography = "Có",
                        ...
                        new
                        {
                            ID = new Guid("53cc7f6f-c996-4cc4-809d-33359992a918"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("da3304f6-3775-4bcd-af7e-7367b57c4b4b"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("ca2e3e94-0e25-4589-92e6-adc635e3679f"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("c4b5a0dd-1cd8-4a80-9547-5acff9322e92"),
                            GenreName = "Kịch tính"
                        },
                        new
                        {
                            ID = new Guid("d70f2300-381c-425a-8162-a3cf34d228bf"),
                            GenreName = "Tình cảm"
                        },
                        new
                        {
                            ID = new Guid("bfc1c695-2bff-4cf4-a7e1-08505d8dc9c7"),
                            GenreName = "2D"
                        },
                        new
                        {
                            ID = new Guid("d3dc09bf-b23d-4e70-a400-90f913d0a58c"),
                            GenreName = "Hoạt hình"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("46f5ae75-a196-49fd-9719-3abbb56b8725"),
                            LanguageName = "en"
                        },
                        new
                        {
                            ID = new Guid("68c0ab5b-9f8d-4b1c-ae17-2b4c92558c76"),
                            LanguageName = "vi"
                        },
                        new
                        {
                            ID = new Guid("fe707ac9-7e27-46be-981f-e1be1c611aa1"),
                            LanguageName = "ja"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("eb462249-5821-47da-9c16-c89c9f076195"),
                            ...
                            PromotionCodeID = new Guid("e5f32b71-a2b4-4d51-8f8a-77966e5ca00c"),
                            PromotionTypeID = new Guid("61752b6e-345f-4760-99f3-dcdba56fa5d9"),
                            StartDate = new DateTime(2024, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ID = new Guid("f3f982ae-1c48-4e24-af0f-ac7db7a4c8c8"),
                            ...
                            PromotionCodeID = new Guid("f0519cdd-cce0-474f-b3a6-4855a6599367"),
                            PromotionTypeID = new Guid("596dea20-b3d2-443a-9fb0-0efa9ae3789b"),
                            StartDate = new DateTime(2024, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UserID = new Guid("3c7c99b0-a49d-4aca-8b13-643fa0f0d5ed")
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.PromotionCode", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("e5f32b71-a2b4-4d51-8f8a-77966e5ca00c"),
                            Code = "TET2024",
                            EndDate = new DateTime(2024, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            MaxUsage = 100,
                        ...
                        new
                        {
                            ID = new Guid("f0519cdd-cce0-474f-b3a6-4855a6599367"),
                            Code = "VIP2024",
                            EndDate = new DateTime(2024, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            MaxUsage = 50,
                            StartDate = new DateTime(2024, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.PromotionType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("596dea20-b3d2-443a-9fb0-0efa9ae3789b"),
                            Description = "Giảm giá theo phần trăm tổng hóa đơn",
                            Name = "Giảm giá phần trăm"
                        },
                        new
                        {
                            ID = new Guid("61752b6e-345f-4760-99f3-dcdba56fa5d9"),
                            Description = "Giảm giá một số tiền cụ thể trên hóa đơn",
                            Name = "Giảm giá cố định"
                        },
                        new
                        {
                            ID = new Guid("13e9b416-24bd-448b-81c5-4448890389b2"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(8883),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(8902),
                            RoleName = "Client",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(8905),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("be3cdc03-3344-476a-a027-f4af453c0ed5"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(8979),
                        ...
                        new
                        {
                            ID = new Guid("0fa95db0-ef07-409d-87a3-0141dbb0adda"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(9339),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("76700b28-96ba-45b8-a481-881cdebad879"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(9379),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("74bb69f7-ae3d-4af5-b6be-b675aba4e96b"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(9408),
                        ...
                        new
                        {
                            ID = new Guid("ed6d825d-cc33-4294-a828-f83b17d4e122"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(9434),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("3736c1f8-397d-4074-8ea1-2104ba01a8c8"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(9469),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("79d5397a-7b58-4f87-9b42-2957a94cd8d2"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(9495),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "vantrongvt1310@gmail.com",
                            FullName = "Nguyễn Văn Trọng",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("413fd50f-563a-414b-9ff5-6bbbf7d835dd"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(9519),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "Phongdxph35748@fpt.edu.vn",
                            FullName = "Đặng Xuân Phong",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("9730aa75-e9c7-4c37-a7ac-5f3179ebbdea"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 5, 8, 20, 22, 259, DateTimeKind.Local).AddTicks(9546),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "cuongddpc07789@fpt.edu.vn",
                            FullName = "Đặng Đức Cường",
                            Gender = true,

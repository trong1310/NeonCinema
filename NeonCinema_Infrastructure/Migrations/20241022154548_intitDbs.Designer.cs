...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20241022154548_intitDbs")]
    partial class intitDbs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Countrys", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("f3271e25-eede-4a80-b9c5-b912d2908bab"),
                            CountryName = "Nhật Bản"
                        },
                        new
                        {
                            ID = new Guid("57badfac-91b1-44f4-b5ac-968c9753feeb"),
                            CountryName = "Vương Quốc Anh"
                        },
                        new
                        {
                            ID = new Guid("1e7c9424-4e79-45a5-b27e-2dc256d5b9fb"),
                            CountryName = "Trung Quốc"
                        },
                        new
                        {
                            ID = new Guid("f22e6b69-fd58-48ba-8c1d-898d74f12eac"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Director", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("fc3ea008-94f1-4097-901a-5764ba3c32c7"),
                            Address = "Hà Nội",
                            Biography = "Có",
                        ...
                        new
                        {
                            ID = new Guid("d269f3ff-c876-44a1-b350-7a4abd972559"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("1ef08494-bd13-42bf-8785-d8928ce36871"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("c847b63f-3849-48dc-9fc1-17bf29aa9b2f"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("68da1164-5ab8-4160-8a60-55f2bc69ef2a"),
                            GenreName = "Kịch tính"
                        },
                        new
                        {
                            ID = new Guid("3421cbe2-b201-47fd-a7f1-2746c98c9841"),
                            GenreName = "Tình cảm"
                        },
                        new
                        {
                            ID = new Guid("0f0dfeed-dfb6-4fb5-bde1-b46b1ceb2363"),
                            GenreName = "2D"
                        },
                        new
                        {
                            ID = new Guid("d4f3d1e4-9106-4cfb-b717-9ffdd8f7ea8e"),
                            GenreName = "Hoạt hình"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("194cdf73-d5b7-411d-afe3-0bec6a362b2c"),
                            LanguageName = "en"
                        },
                        new
                        {
                            ID = new Guid("ff3acb8b-420d-417c-9bfd-8d6193a174c2"),
                            LanguageName = "vi"
                        },
                        new
                        {
                            ID = new Guid("3e3acc6d-69a1-42bc-ae90-c97af4473a25"),
                            LanguageName = "ja"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2185),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2205),
                            RoleName = "Customer",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2207),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("efc58df5-7336-4ccd-bbcc-1bcf83cd557d"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2307),
                        ...
                        new
                        {
                            ID = new Guid("5f9e09a6-1801-4fa3-8419-5a1692ffd88d"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2634),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("29f4fcd9-b6f0-467b-9e60-73dae0f9a987"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2684),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("51bf8775-2ad8-42f6-93da-e2fffff8bb5e"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2726),
                        ...
                        new
                        {
                            ID = new Guid("0033ffa4-c917-4cfd-bc86-bd8728dc42fa"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2759),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("fbf34fdd-b524-49c8-ab25-4879e6d591db"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2792),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("82e31ca0-2f8d-420d-b84b-2206e7d0024f"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2831),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "vantrongvt1310@gmail.com",
                            FullName = "Nguyễn Văn Trọng",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("c17b83b6-d926-420e-a9f2-7cf67a3c0e4d"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2859),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "Phongdxph35748@fpt.edu.vn",
                            FullName = "Đặng Xuân Phong",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("6f3a3887-db76-4b76-82de-d76bf9ef9064"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 22, 22, 45, 47, 787, DateTimeKind.Local).AddTicks(2889),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "cuongddpc07789@fpt.edu.vn",
                            FullName = "Đặng Đức Cường",
                            Gender = true,

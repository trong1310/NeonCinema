...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20241023162541_initnews")]
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Cinemas", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("6e34120f-7bfe-42af-a5af-ec02adf309b9"),
                            ClosingHours = "10:00 PM",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2913),
                            Location = "Hà Nội",
                            Name = "Cinema A",
                        ...
                        new
                        {
                            ID = new Guid("30b4a0b1-f898-49c8-91e8-f9d23f7a5e66"),
                            ClosingHours = "11:00 PM",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2917),
                            Location = "Đà Nẵng",
                            Name = "Cinema B",
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Countrys", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("7e509f35-c4d4-45b5-9305-4157969897dd"),
                            CountryName = "Nhật Bản"
                        },
                        new
                        {
                            ID = new Guid("23cb162f-df23-4f4c-a24b-482ec5961421"),
                            CountryName = "Vương Quốc Anh"
                        },
                        new
                        {
                            ID = new Guid("1754c1cd-0eb5-43db-93de-23403e814e57"),
                            CountryName = "Trung Quốc"
                        },
                        new
                        {
                            ID = new Guid("0023ef76-6613-4ef0-8de7-dfa2877bf5c3"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Director", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("7207e24d-6d58-4598-ae47-6b75d57afac7"),
                            Address = "Hà Nội",
                            Biography = "Có",
                        ...
                        new
                        {
                            ID = new Guid("4ad0a35f-16f1-45d2-ad0a-3ce4435472e8"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("5e575b31-2f44-4ad6-b1df-2d1a5972cb1e"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("04300f96-84e1-4316-8d0f-2a489341068f"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("06848a57-8738-4d38-b637-5d91e2a19f6b"),
                            GenreName = "Kịch tính"
                        },
                        new
                        {
                            ID = new Guid("4a49dea9-ae94-48f7-8886-f670dd6118ce"),
                            GenreName = "Tình cảm"
                        },
                        new
                        {
                            ID = new Guid("ba5455eb-fe4a-4b08-8a81-b80125269e7f"),
                            GenreName = "2D"
                        },
                        new
                        {
                            ID = new Guid("874e4577-412c-4c3d-ac4f-2e15cac465ad"),
                            GenreName = "Hoạt hình"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("f4759d29-d9d3-44be-b822-869c9bbf59ff"),
                            LanguageName = "en"
                        },
                        new
                        {
                            ID = new Guid("7582b15b-35f3-485b-a803-3431db94e24f"),
                            LanguageName = "vi"
                        },
                        new
                        {
                            ID = new Guid("65e47379-44d9-47a7-8a4d-d56551a6e7b6"),
                            LanguageName = "ja"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Movies", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("dc54054e-f86a-4aca-a3e5-902748a4f7d6"),
                            AgeAllowed = 18,
                            CountryID = new Guid("7e509f35-c4d4-45b5-9305-4157969897dd"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(3167),
                            Description = "An exciting action movie.",
                            DirectorID = new Guid("7207e24d-6d58-4598-ae47-6b75d57afac7"),
                            Duration = 120,
                            GenreID = new Guid("06848a57-8738-4d38-b637-5d91e2a19f6b"),
                            Images = "movieA.jpg",
                            LenguageID = new Guid("f4759d29-d9d3-44be-b822-869c9bbf59ff"),
                            Name = "Movie A",
                        ...
                        new
                        {
                            ID = new Guid("71d5e3cd-eec8-46ee-b91a-c390b7bfad5c"),
                            AgeAllowed = 16,
                            CountryID = new Guid("23cb162f-df23-4f4c-a24b-482ec5961421"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(3177),
                            Description = "A thrilling mystery.",
                            DirectorID = new Guid("4ad0a35f-16f1-45d2-ad0a-3ce4435472e8"),
                            Duration = 150,
                            GenreID = new Guid("4a49dea9-ae94-48f7-8886-f670dd6118ce"),
                            Images = "movieB.jpg",
                            LenguageID = new Guid("7582b15b-35f3-485b-a803-3431db94e24f"),
                            Name = "Movie B",
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(1975),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(1994),
                            RoleName = "Customer",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(1996),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Room", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("f11858a8-c9b4-4610-bec2-270fc11d9ddd"),
                            CinemasID = new Guid("6e34120f-7bfe-42af-a5af-ec02adf309b9"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(3069),
                            Name = "Room 1",
                            SeatID = new Guid("5e57233c-5f28-430e-92d9-fb8aa057afb4"),
                            SeatingCapacity = 100,
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("55a8a41d-70df-4223-94e2-fe7f9c1123ea"),
                            CinemasID = new Guid("30b4a0b1-f898-49c8-91e8-f9d23f7a5e66"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(3074),
                            Name = "Room 2",
                            SeatID = new Guid("5e57233c-5f28-430e-92d9-fb8aa057afb4"),
                            SeatingCapacity = 150,
                            Status = 1
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Screening", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("7e8a3410-cb70-46b5-8c2e-08ffd3d02f36"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(3219),
                            MovieID = new Guid("dc54054e-f86a-4aca-a3e5-902748a4f7d6"),
                            RoomID = new Guid("f11858a8-c9b4-4610-bec2-270fc11d9ddd"),
                            ShowDate = new DateTime(2024, 10, 25, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(3209),
                            ShowTimeID = new Guid("9907377e-775c-4c57-91da-6bca3bd48569"),
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("7d3f0333-8b87-4459-a76e-ce3c7b96639e"),
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(3224),
                            MovieID = new Guid("71d5e3cd-eec8-46ee-b91a-c390b7bfad5c"),
                            RoomID = new Guid("55a8a41d-70df-4223-94e2-fe7f9c1123ea"),
                            ShowDate = new DateTime(2024, 10, 28, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(3223),
                            ShowTimeID = new Guid("714755a1-be4e-472e-8b47-56c29e3b7936"),
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Seat", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("5e57233c-5f28-430e-92d9-fb8aa057afb4"),
                            Column = "1",
                            Row = "1",
                            SeatNumber = "1",
                            SeatTypeID = new Guid("d555f10a-0e6f-49e8-9feb-8c369567b4ef"),
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("24305498-79c8-432e-a5aa-278046acb971"),
                            Column = "2",
                            Row = "2",
                            SeatNumber = "2",
                            SeatTypeID = new Guid("dff8356c-4ef6-48f2-8915-f6e2b8a994f0"),
                            Status = 1
                        },
                        new
                        {
                            ID = new Guid("4852a5d8-0f2a-4f1a-ae2b-8dcb04793414"),
                            Column = "2",
                            Row = "2",
                            SeatNumber = "2",
                            SeatTypeID = new Guid("0aac95eb-b40a-418d-b669-b3d40659de19"),
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.SeatType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("d555f10a-0e6f-49e8-9feb-8c369567b4ef"),
                            Price = 500000m,
                            SeatTypeName = "Ghế Vip"
                        },
                        new
                        {
                            ID = new Guid("dff8356c-4ef6-48f2-8915-f6e2b8a994f0"),
                            Price = 250000m,
                            SeatTypeName = "Ghế Thường"
                        },
                        new
                        {
                            ID = new Guid("0aac95eb-b40a-418d-b669-b3d40659de19"),
                            Price = 400000m,
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.ShowTime", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("9907377e-775c-4c57-91da-6bca3bd48569"),
                        ...
                        new
                        {
                            ID = new Guid("714755a1-be4e-472e-8b47-56c29e3b7936"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("ca0e2c1a-8583-4fc2-a59e-b4a0a40c0981"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2087),
                        ...
                        new
                        {
                            ID = new Guid("e4c0dbda-5d59-4b86-a869-469aa62e831c"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2461),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("1b8400a5-9602-4025-a2bb-a84d79ef98c8"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2490),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("8089722c-3fc3-4d74-975a-86ddeb74a83e"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2514),
                        ...
                        new
                        {
                            ID = new Guid("62f868ba-38b9-458e-8aa7-1302d4fe4ced"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2564),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("632f908a-0ef5-4590-b9ab-66d1626e3308"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2588),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("bf4dcbbc-3ed9-4942-b702-284e17f8c09a"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2620),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "vantrongvt1310@gmail.com",
                            FullName = "Nguyễn Văn Trọng",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("9be0d956-8cfa-4580-ad4f-0cd00028f6d8"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2641),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "Phongdxph35748@fpt.edu.vn",
                            FullName = "Đặng Xuân Phong",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("941b7ee2-4a3b-433c-aaf3-55741d3cb69f"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 23, 23, 25, 41, 174, DateTimeKind.Local).AddTicks(2668),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "cuongddpc07789@fpt.edu.vn",
                            FullName = "Đặng Đức Cường",
                            Gender = true,

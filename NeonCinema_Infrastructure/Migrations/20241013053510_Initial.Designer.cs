...
namespace NeonCinema_Infrastructure.Migrations
{
    ...
    [Migration("20241013053510_Initial")]
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Countrys", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("1bd8edd4-20e2-4f5b-a250-061846b8258a"),
                            CountryName = "Nhật Bản"
                        },
                        new
                        {
                            ID = new Guid("ffa1a4d6-ac3e-492a-a88a-110a1603d576"),
                            CountryName = "Vương Quốc Anh"
                        },
                        new
                        {
                            ID = new Guid("e30d1a5d-c01a-4ea1-b985-838e9846178d"),
                            CountryName = "Trung Quốc"
                        },
                        new
                        {
                            ID = new Guid("2781b3ce-76ab-40f4-b382-527135a6fad7"),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Director", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("b1954366-b2aa-45ce-808c-f3ceecdce255"),
                            Address = "Hà Nội",
                            Biography = "Có",
                        ...
                        new
                        {
                            ID = new Guid("847a7467-9cc1-4949-8ebb-1b0862d982a1"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("e786b0c4-d9c1-4211-af06-215e7c7e0d93"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("35b0ce10-3e94-4be8-96e1-b2f66a594916"),
                            Address = "Hà Nội",
                            Biography = "Có",
                            BirthDate = new DateTime(2000, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("17d6fbb7-edc7-4f13-ae6e-0c5eb9a4fabc"),
                            GenreName = "Kịch tính"
                        },
                        new
                        {
                            ID = new Guid("6f450011-a816-424d-ae6f-42d456f2ecc1"),
                            GenreName = "Tình cảm"
                        },
                        new
                        {
                            ID = new Guid("7117b718-e5ba-4f87-958f-859a59fd15db"),
                            GenreName = "2D"
                        },
                        new
                        {
                            ID = new Guid("5999ae42-ab0a-4249-aaac-9f74922a3c4a"),
                            GenreName = "Hoạt hình"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Language", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("10735713-bb59-4b25-9086-fc921241c3e2"),
                            LanguageName = "en"
                        },
                        new
                        {
                            ID = new Guid("dd4bd770-2951-41ba-b47e-28841c1e0c67"),
                            LanguageName = "vi"
                        },
                        new
                        {
                            ID = new Guid("5277b051-05f3-4198-904e-5145a76c53b7"),
                            LanguageName = "ja"
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7263),
                            RoleName = "Admin",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7288),
                            RoleName = "Client",
                            Status = 1
                        },
                        new
                        {
                            ...
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7290),
                            RoleName = "Staff",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("NeonCinema_Domain.Database.Entities.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = new Guid("83baf9cf-3117-45a0-a241-717868903c15"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7369),
                        ...
                        new
                        {
                            ID = new Guid("e4abc6be-ee95-4144-a1f2-77ec62cd8964"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7743),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("bedb7de1-b427-460f-80cd-7635e97c01a4"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7768),
                            DateOrBriht = new DateTime(2004, 12, 25, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("97387c19-dae3-4b27-a99a-bbb9fbaf5a76"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7791),
                        ...
                        new
                        {
                            ID = new Guid("d15a5e01-af0b-41f5-b39c-cf7f08c0a16c"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7810),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("119f28da-36e9-4f6d-8434-025e42d8e4ed"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7849),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = new Guid("fa90600a-8673-44df-94d4-92dd38a41be1"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7869),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "vantrongvt1310@gmail.com",
                            FullName = "Nguyễn Văn Trọng",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("f4b48e52-cdd1-42b2-bc37-f7f862443869"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7888),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "Phongdxph35748@fpt.edu.vn",
                            FullName = "Đặng Xuân Phong",
                            Gender = true,
                        ...
                        new
                        {
                            ID = new Guid("7d3e9013-cf5e-4b07-8168-c2172463a9a3"),
                            Adderss = "Ba Vi",
                            CreatedTime = new DateTime(2024, 10, 13, 12, 35, 9, 873, DateTimeKind.Local).AddTicks(7907),
                            DateOrBriht = new DateTime(2004, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "cuongddpc07789@fpt.edu.vn",
                            FullName = "Đặng Đức Cường",
                            Gender = true,

...
namespace NeonCinema_API.Controllers.Movie
{
	...
	public class MovieController : ControllerBase
	{
		...
		public MovieController(IMovieRepositories reps, IMapper map, NeonCinemasContext context)
		{
			_context = context;
			_map = map;
			_reps = reps;
		...
		[HttpGet("GetStopShowing")]
		public async Task<IActionResult> GetStopShowing()
		{
			var obj = await _reps.GetFilmsStopShowing();
			return Ok(obj);
		}
		[HttpPost("Create")]
